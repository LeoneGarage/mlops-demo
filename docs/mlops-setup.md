...
[ML Config](../mlops/resources/README.md)  guides to make changes to ML code or deployed jobs.
...
[ML pull request guide](ml-pull-request.md) and [ML resource config guide](../mlops/resources/README.md)  to propose, test, and deploy
